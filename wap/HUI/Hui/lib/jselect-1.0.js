 ...
 *
 * 如果page上select有的不想通过该脚本替换，只想维持系统select，可以在相应的select元素新增自定义属性data-enabled="true"，
 * 否则可以在想要通过该脚本替换的select元素上新增自定义属性data-enabled="false"或者不加，会默认为这个select需要
 * 通过该脚本进行替换
 *
 * 日期：2012-11-07 15:38
 */
(function(squid) {
    ...
    JSelect.prototype = {
        ...
        globalEvent: function() {
            //document 新增click事件，用户处理每个jselect元素展开关闭
            var target,
                className,
                elem,
                wrapper,
