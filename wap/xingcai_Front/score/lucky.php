   ...
   <div class="col-sm-4" style="PADDING-TOP: 6;">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <p>根据儲值金额获得免费抽奖机会，免费抽奖剩余<code id="sycj_count"><?=$no_prize?></code>次。
                    </p>
<p>
                    <h3 class="font-bold">
						  您当日儲值为<code><?=$recharge_money['amount']?></code>元。
                        </h3>
						</p>
                    <p>
                       <?php if($chou1['data']){ foreach ($chou1['data'] as $key => $value) {?>
		<span>当日儲值<font color="red"><?=$value['min_cz_money']?>-<?=$value['max_cz_money']?></font>元，可免费抽奖1次，奖金<font color="red"><?=$value['min_prize_money']?>-<?=$value['max_prize_money']?></font>元</span>
