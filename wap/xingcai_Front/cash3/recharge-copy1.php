...
<table width="100%" border="0" cellspacing="1" cellpadding="4" class='table_b'>
	...
	<div class="form_switch_main">
	  <form action="/qwpay/req.php" method="POST" name="a32" target="_blank" id="frm1">
...
<br>
&nbsp;<img src="/images/zfb.jpg" alt=""></p>

<p>1.每次"儲值编号"均不相同,务必将"儲值编号"正确复制填写到引号汇款页面的"说明"栏目中;<br>
