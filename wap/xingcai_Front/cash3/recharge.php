 ...
 <section class="wraper-page">
    ...
    <div id="mainContent">
        ...
        <div id="contentBox">	
		 <div class="step">
		     <div class="item">
                        <div class="item_l">儲值处理时间：</div>
                        <div class="item_r"><span class="z_font1">7*24小时儲值服务</span></div>
                </div>
			<!-- 逻辑内容开始 -->
			<div data-init="content" class="content">
				...
				<div class="item">
                        <div class="item_l money_hanggao">儲值金额(人民币)：</div>
                        <div class="item_r">
				...
				<div class="item">
                        ...
                        <div class="item_r">
						 <input name="vcode" maxlength="4" type="text" class="text" style="width:75px;padding-top:5px; border-radius: 0.285714rem;"/>
				...
				<div class="cz_btn_box">
					...
					<input id="setcz" class="next" type="submit" value="进入儲值" >
                </div>
                  </div>
                  </div> </div>
                  </div>
...
﻿</div>	
	...
	<div id="subContent_bet_re">
		<div id="error">
		<h3>
			<font class="hint_red">由于银行网络原因，儲值暂停！给您带来不便敬请谅解！</font>
		</h3>
