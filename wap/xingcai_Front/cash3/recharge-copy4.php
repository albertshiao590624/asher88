...
<table width="100%" border="0" cellspacing="1" cellpadding="4" class='table_b'>
    <tr class='table_b_th'>
     ...
     <tr height=25 class='table_b_tr_b'>
      ...
      <th scope="col" style="background: #FFFFFF;color: #888;font-size: 15px;border-bottom: 1px dashed #ddd;width: 50%;height: 50px;text-indent: 16px;">儲值金额：<?=$args[0]['amount']?></th>
      <th scope="col" style="background: #fff;height:50%;color: #888;border-bottom: 1px dashed #ddd;font-size: 15px;">儲值编号 ：<?=$args[0]['rechargeId']?></th>
	...
	<p id="linkTip" style="color:#f00; margin-top:5px; position:absolute; top:100px;">*注意：在线儲值付款成功后，请等待30s后再关闭儲值的窗口，以防资金不到账。若付款后未到账，请联系客服。</p>
</div>
</div>
</form>
</div>
...
<h2>儲值类型：<?=$memberBank['bankName']?></h2>
<h2>收款户名：<?=$memberBank["username"]?></h2>
<h2>收款账号：<?=$memberBank["account"]?></h2>
<h2>儲值金额：<?=$args[0]['amount']?></h2>
<h2>儲值编号：<?=$args[0]['rechargeId']?></h2>
<p>长按以下二维码保存图片进入支付宝扫一扫儲值<br>
手机app请截图扫描<br>
<br>
&nbsp;<img src="/zfb.jpg" alt=""></p>

<p><font color="#FF0000">1.每次"儲值编号"均不相同,务必将"儲值编号"正确复制填写到引号汇款页面的"留言"栏目中;</font><br>
2.二维码不固定，转帐前请仔细核对该帐号;<br>
3.儲值金额与转账金额不符，儲值将无法到账;<br>
4.转账后如10分钟未到账，请联系客服，告知您的儲值编号和您的儲值金额。<br>
5.支付宝，微信，财付通，手动儲值可忽略以上几点。</p>
</div>
</div>
<!---------------------------------------------微信手动支付--------------------------------------------------------->
...
<h2>儲值金额：<?=$args[0]['amount']?></h2>
<h2>儲值编号：<?=$args[0]['rechargeId']?></h2>
<p>长按以下二维码保存图片进入微信扫一扫儲值<br>
手机app请截图扫描<br>
<br>
&nbsp;<img src="/wx.jpg" alt=""></p>
...
<table width="100%" border="0" cellspacing="1" cellpadding="4" class='table_b'>
    ...
    <tr height=25 class='table_b_tr_b' >
      <td align="right" class="copys">儲值银行：</td>
	...
	<tr height=25 class='table_b_tr_b'>
	 ...
	 <button class="layui-btn layui-btn-normal" type="button" onClick="copyUrl1()" >复制</button></td> 
    </tr>
    <tr height=25 class='table_b_tr_b' >
      <td align="right" class="copys" >收款账号：</td>
      <td align="left" ><input id="bank-account" readonly value="<?=$memberBank["account"]?>" />
	 <button class="layui-btn layui-btn-normal" type="button" onClick="copyUrl2()" >复制</button>
	  </td> 
    </tr>
     <tr height=25 class='table_b_tr_b'>
      <td align="right" class="copys">儲值金额：</td>
	 ...
	 </div>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<div class="spn12" style="display:inline;">*网银儲值金额必须与网站填写金额一致方能到账！</div>
      </td>
    </tr>
     <tr height=25 class='table_b_tr_b'>
      <td align="right" class="copys">儲值编号：</td>
      <td align="left"><input id="username" readonly value="<?=$args[0]['rechargeId']?>" />
        ...
        </div>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<div class="spn12"  style="display:inline;">*网银儲值请务必将此编号填写到汇款“附言”里，每个儲值编号仅用于一笔儲值，重复使用将不能到账！</div>
	   </td> 
    </tr>
<!--左边栏body结束-->
<?php if($memberBank["rechargeDemo"]){?>
   <tr height=25 class='table_b_tr_b'>
      ...
      <td align="left" > <div class="example">儲值图示：<div class="example2" rel="<?=$memberBank["rechargeDemo"]?>">查看</div></div></td> 
  </tr>
<? }?>
<tr>
<div class="tips">
	<dl>
        <dt>儲值说明：</dt>
        <dd>1.每次"儲值编号"均不相同,务必将"儲值编号"正确复制填写到引号汇款页面的"附言"栏目中;</dd>
        <dd>2.帐号不固定，转帐前请仔细核对该帐号;</dd>
        <dd>3.儲值金额与网友转账金额不符，儲值将无法到账;</dd>
        <dd>4.转账后如10分钟未到账，请联系客服，告知您的儲值编号和您的儲值金额及你的银行用户姓名。</dd>
    </dl>
</div>
</tr>
</table> 
