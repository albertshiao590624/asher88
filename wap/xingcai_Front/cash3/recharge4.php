        ...
        <div class="bg clearfix">
        	<div id="siderbar">
                <ul class="list clearfix">
                    <li class=""><a href="/index.php/cash/recharge" >在线儲值</a></li>
					<li class=""><a href="/index.php/cash/recharge2">网银手动儲值</a></li>
					<li class=""><a href="/index.php/cash/recharge3">微信手动儲值</a></li>
					<li class="current"><a href="/index.php/cash/recharge4">支付宝手动儲值</a></li>
                </ul>
            </div>
...
<?php
			$set=$this->getSystemSettings();
				$sql="select * from {$this->prename}bank_list b, {$this->prename}sysadmin_bank m where m.admin=1 and m.enable=1 and b.isDelete=0 and b.id=m.bankId and b.id not in(1,2,4,6,12,20,21)";
        ...
        <div>
        在线儲值一 注意事项：<br>
        点击下一步根据提示完成支付，支付成功后一定要等待跳转到商家页面或等待自动跳转，显示儲值订单成功后再关闭网页，如未自动到账请复制订单编号联系在线客服核查！
    </div>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
              <tbody><tr>
                ...
                <span class="red">&nbsp;&nbsp;(单笔儲值限额：最低 <span><?=$set['rechargeMin']?></span>,最高 <span><?=$set['rechargeMax']?></span>)
               </span></td>
              </tr>

              <tr>
                <td align="right">儲值金额(大写)：</td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
              ...
              <tr>
				...
				<div id="2tips" data="0"></div>
				  ...
				  <input name="" type="button" value="返回" class="formBack" onclick="javascript:history.back();">
				  </div>
	...
	<div class="container" style=" width: auto">
		<div id="error">
			<h3 class="title">	
			<font color="#ff0000">对不起，未开通该银行的儲值权限，请使用在线儲值或其它银行进行儲值。</font>
			</h3>
		</div>
	</div>
	<?php }?>	
