...
<li class="current"><a href="/index.php/cash/rechargeLog" >儲值记录</a></li>
     ...
     <form action="/index.php/cash/rechargelist" target="ajax" onajax="BeforeSearchRechargeRecord" call="SearchRechargeRecord" dataType="html">
        ...
        <div id="searchBox" class="re">
        	<div class="inlineBlock">
            	<label>儲值时间：</label><input type="text" class="input150" value="<?= $this->iff($_REQUEST['fromTime'], $_REQUEST['fromTime'], date('Y-m-d H:i', $GLOBALS['fromTime'])) ?>" name="fromTime" id="datetimepicker" /> <span class="image"></span>
            </div>
            <label>至</label>
            <div class="inlineBlock">
