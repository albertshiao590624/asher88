			...
			<div class="air_box_t">
				<div class="airflash" id="air_top">
    				...
    				<script type="text/javascript">
			            ...
			            so.addVariable("appurl", "http://dl3.enjoysincai.net/download/Main.air"); // 在这里修改阿舍仔娛樂城AIR客户端下载地址，air名称Main可以随意修改
...
<div class="login_footer">
	<div class="warp980">
		...
		<div class="clearfix">
			...
			<p class="t-right">
				未滿18周歲禁止購買<br />
				Copyright © 2010-2017  阿舍仔娛樂城版權所有
			</p>
		</div>
	</div>
</div>
...
<div class="sidebar" id="sidebar">
	...
	<a  href="<?=$this->settings['kefuGG']?>" target="_blank" class="sidebar-div"><i class="ic-online"></i>在线客服</a>
