...
<head>
<?php $this->display('inc_skin.php', 0 , '線上會員 - 代理中心'); ?>
<style>
...
<div style="width:880px; height:42px; border-bottom:11px solid #ff9f08;">
	<div style="width:100%; height:30px; margin-top:10px;">
        ...
        <div class="dh_68_1" style="width:700px; float:left; height:30px;">
        	<ul>
            	<li class="aafbfg"><a href="/index.php/team/memberList">會員管理</a></li>
				<li class="aafbfg"><a href="/index.php/team/onlineMember">線上會員</a></li>
                <li class="aafbfg"><a href="/index.php/team/gameRecord">團隊記錄</a></li>
                <li class="aafbfg"><a href="/index.php/team/report">團隊盈虧</a></li>
                <li class="aafbfg"><a href="/index.php/team/coinall">團隊統計</a></li>
                <li class="aafbfg"><a href="/index.php/team/coin">團隊帳變</a></li>
                <li class="aafbfg"><a href="/index.php/team/cashRecord">團隊提現</a></li>
                <li class="aafbfg"><a href="/index.php/team/linkList">推廣連結</a></li>
                <?php if($this->user['fanDian'] == '13.0' || $this->user['fanDian'] == '12.9'){?>
                <li class="fontback"><a href="/index.php/team/shareBonus"><font style="color:#890e0e;">代理分紅</font></a></li>
                <?}?>
            </ul>
        </div>
    </div>
