...
<div class="ibox-title">
    ...
    <form action="/index.php/team/searchMember" dataType="html" target="ajax" method="get" onajax="teamBeforeSearchMember" call="teamSearchMember">
			...
			<button class="btn btn-white" type="button">下級帳號</button>	
			</span>				
		  <input type="text" class="input-large form-control" placeholder="請輸入需要查詢的帳號名" name="username"/>  
			</div>
          <div class="input-append input-group" "="">					
			<span class="input-group-btn">				
			 
			<button class="btn btn-white" type="button">查詢類型</button>	
			</span>				
