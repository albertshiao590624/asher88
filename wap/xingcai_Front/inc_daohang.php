...
<body>
	<div id="body">
		...
		footer .footmenu{position: absolute; width:100%; bottom:0; left:0; height: 52px; overflow: hidden;}
		footer .footmenu a{display:block; float:left; width:25%; height:100%; text-decoration:none;}
	</style>
	<footer>
		<div class='footmenu'>
			<a href='/index.php'></a>
			<a href='/index.php/zryl/index'></a>
			<a href="/index.php/scjy/index"></a>
			<a href='/index.php/safe/Personal'></a>
		</div>
		<img width='100%' src='/images/footer.png' />
	</footer>
		<header class="header">
		<script type="text/javascript" src="//js.users.51.la/20343521.js"></script>
	...
	<div class="wercom">歡迎您,<b class="username"> <?=$this->user['username']?></b>
...
<!--侧导航 -->
		<section class="slide-bar" style="display: none;">
			<ul class="tree">
				...
				<li class="tree_list">
	                <h3 class="one_nav_list uc_icon_r"><a href="/index.php/safe/Personal">管理中心</a></h3>
	                <div class="m_nav_line"></div>
				</li>
					...
					<ul class="tree_one" style="display:block">
						...
						<div class="m_nav_line"></div>
							<dl>
								...
								<dd>
									<ul class="lot_list">
									<!--	<li><a href="/index.php/index/game/1/2/12">重庆时时彩</a> </li>
										...
										<li><a href="/index.php/index/game/26/59/193">东京2分彩<i>H</i></a> </li>
										<li><a href="/index.php/index/game/14/59/193">腾讯五分彩<i>H</i></a></li>
										<li><a href="/index.php/index/game/76/59/193">韩国1.5分彩<i>H</i></a></li>
										<li><a href="/index.php/index/game/75/59/193">巴西快乐彩<i>H</i></a></li>
										<li><a class="xg_6hc" href="/index.php/index/game/34">香港六合彩</a></li>
							...
							<dt>PK拾</dt>
								<dd>
									<ul class="lot_list">
										...
										<li><a href="/index.php/index/game/55">幸运飞艇</a> </li>
										<li><a href="/index.php/index/game/80">SG飞艇</a> </li>
							...
							<dt>11选5</dt>
								<dd>
									<ul class="lot_list">
										...
										<li><a href="/index.php/index/game/68">台湾11选5<i>H</i></a></li>
									</ul>
								</dd>
							</dl>
							<!--<dl>
							<!--<dt>基诺彩</dt>
								<dd>
									<ul class="lot_list">
										<li><a href="/index.php/index/game/78">北京快乐8</a> </li>
				...
				<?}?>
				<li class="tree_box tree_list">
					<h3 class="one_nav_list account_icon">儲值提现<i class="lnstruction-top"></i></h3>
					<ul class="tree_one">
						<li class="lotter_list_game">
							<div class="m_nav_line"></div>
								<dl class="lnstruction">
									<dd>
										<ul class="lot_list">
											...
											<li class="tree_list"> <a href="/index.php/cash/rechargeLog">儲值记录</a></li>
