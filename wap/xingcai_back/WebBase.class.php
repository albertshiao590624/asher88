...
class WebBase extends Object{
	...
	public function noxHdxyft(&$actionNo, &$actionTime, $time=null){/*幸运飞艇*/
	...
	public function BJpk10(&$actionNo, &$actionTime, $time=null){
		$this->setTimeNo($actionTime, $time);
		$actionNo = 44*(strtotime(date('Y-m-d', $time))-strtotime('2007-11-18'))/3600/24+$actionNo+548859;
	}
	//北京快乐8
	...
	public function amxync(&$actionNo, &$actionTime, $time=null){
		$this->setTimeNo($actionTime, $time);
		$actionNo=date('2019md', $time).substr(1000+$actionNo,1);
	}	
	...
	public function gd11(&$actionNo, &$actionTime, $time=null){
		...
		$actionNo=date('2019md', $time).substr(100+$actionNo,1);
	}	
	
	public function sy_JS_jsft(&$actionNo, &$actionTime, $time=null){/*SG飞艇*/
		$this->setTimeNo($actionTime, $time);
