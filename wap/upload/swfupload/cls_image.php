 ...
 * ============================================================================
 * $Author: ly $
 * $Id: cls_image.php,v 1.1 2012/02/09 02:37:18 ly Exp $
*/
...
class cls_image
{
     ...
     */
    function make_thumb($img, $thumb_width = 0, $thumb_height = 0, $dir = '',$filename, $bgcolor='')
    {
       ...
       // $filename = $this->unique_name($dir);
        ...
        /* 生成文件 */
        if (ereg("\.(jpg|jpeg)$", strtolower($filename)))
        {
           // $filename .= '.jpg';
            imagejpeg($img_thumb, $dir . $filename,100);
        }
        elseif (ereg("\.(gif)$", strtolower($filename)))
        {
            //$filename .= '.gif';
            imagegif($img_thumb, $dir . $filename);
        }
        elseif (ereg("\.(png)$", strtolower($filename)))
        {
           // $filename .= '.png';
     ...
     * @return TRUE
     */
    public function waterMark($groundImage , $waterPos = 0 , $waterImage = "" , $waterText = "" , $textFont = 15 , $textColor = "#FF0000",$minWidth='100',$minHeight='100',$alpha=0.9){
    	$isWaterImg = FALSE;
